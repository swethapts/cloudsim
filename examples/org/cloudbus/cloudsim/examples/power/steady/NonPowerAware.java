...
public class NonPowerAware {
	...
	public static void main(String[] args) throws IOException {
		String experimentName = "steady_npa";
		...
		try {
			...
			List<Cloudlet> cloudletList = SteadyHelper.createCloudletList(
					brokerId, SteadyConstants.NUMBER_OF_VMS);
			List<Vm> vmList = Helper
					.createVmList(brokerId, cloudletList.size());
			List<PowerHost> hostList = Helper
					.createHostList(SteadyConstants.NUMBER_OF_HOSTS);
