 ...
 */
public abstract class VmSchedulerSteady {

	/** The peList. */
	private List<? extends PeSteady> peList;

	/** The map of VMs to PEs. */
	private Map<String, List<PeSteady>> peMap;
	 ...
	 * @post $none
	 */
	public abstract boolean allocatePesForVm(VmSteady vm, List<Double> mipsShare);
	 ...
	 * @post $none
	 */
	public abstract void deallocatePesForVm(VmSteady vm);
	 ...
	 */
	public List<PeSteady> getPesAllocatedForVM(VmSteady vm) {
	 ...
	 * @return the pe map
	 */
	public Map<String, List<PeSteady>> getPeMap() {
		return peMap;
	}
	 ...
	 */
	protected void setPeMap(Map<String, List<PeSteady>> peMap) {
		this.peMap = peMap;
	}
