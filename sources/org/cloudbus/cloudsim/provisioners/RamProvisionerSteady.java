 ...
 */
public abstract class RamProvisionerSteady {
	 ...
	 * @post $none
	 */
	public RamProvisionerSteady(int ram) {
		setRam(ram);
		setAvailableRam(ram);
	}
	 ...
	 * @post $none
	 */
	public abstract boolean allocateRamForVm(VmSteady vm, int ram);
	 ...
	 */
	public abstract int getAllocatedRamForVm(VmSteady vm);
	 ...
	 * @post none
	 */
	public abstract void deallocateRamForVm(VmSteady vm);
	 ...
	 */
	public abstract boolean isSuitableForVm(VmSteady vm, int ram);
