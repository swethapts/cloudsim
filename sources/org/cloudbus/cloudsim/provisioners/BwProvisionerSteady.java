 ...
 */
public abstract class BwProvisionerSteady {
	 ...
	 * @post $none
	 */
	public BwProvisionerSteady(long bw) {
		setBw(bw);
		setAvailableBw(bw);
	}
	 ...
	 * @post $none
	 */
	public abstract boolean allocateBwForVm(VmSteady vm, long bw);
	 ...
	 */
	public abstract long getAllocatedBwForVm(VmSteady vm);
	 ...
	 * @post none
	 */
	public abstract void deallocateBwForVm(VmSteady vm);
	 ...
	 */
	public abstract boolean isSuitableForVm(VmSteady vm, long bw);
