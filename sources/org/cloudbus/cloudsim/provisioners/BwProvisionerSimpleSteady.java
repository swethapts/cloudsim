 ...
 */
public class BwProvisionerSimpleSteady extends BwProvisionerSteady {
	 ...
	 * @param bw the bw
	 */
	public BwProvisionerSimpleSteady(long bw) {
		super(bw);
	...
	/*
	 * (non-Javadoc)
	 * @see cloudsim.provisioners.BwProvisioner#allocateBwForVm(cloudsim.VmSteady, long)
	 */
	@Override
	public boolean allocateBwForVm(VmSteady vm, long bw) {
	...
	/*
	 * (non-Javadoc)
	 * @see cloudsim.provisioners.BwProvisioner#getAllocatedBwForVm(cloudsim.VmSteady)
	 */
	@Override
	public long getAllocatedBwForVm(VmSteady vm) {
	...
	/*
	 * (non-Javadoc)
	 * @see cloudsim.provisioners.BwProvisioner#deallocateBwForVm(cloudsim.VmSteady)
	 */
	@Override
	public void deallocateBwForVm(VmSteady vm) {
		if (getBwTable().containsKey(vm.getUid())) {
	 ...
	 */
	@Override
	public boolean isSuitableForVm(VmSteady vm, long bw) {
