...
import org.cloudbus.cloudsim.lists.HostListSteady;
import org.cloudbus.cloudsim.lists.PeListSteady;

/**
 * DatacenterCharacteristicsSteady represents static properties of a resource such as resource
 ...
 */
public class DatacenterCharacteristicsSteady {
	...
	/**
	 * Allocates a new DatacenterCharacteristicsSteady object. If the time zone is invalid, then by
	 ...
	 * @post $none
	 */
	public DatacenterCharacteristicsSteady(
			String architecture,
			String os,
			String vmm,
	 ...
	 * @post $none
	 */
	public HostSteady getHostWithFreePe() {
		return HostListSteady.getHostWithFreePe(getHostList());
	}
	 ...
	 * @post $none
	 */
	public HostSteady getHostWithFreePe(int peNumber) {
		return HostListSteady.getHostWithFreePe(getHostList(), peNumber);
	}
	...
	public int getMipsOfOnePe() {
		...
		return PeListSteady.getMips(getHostList().get(0).getPeList(), 0);
	}
	...
	public int getMipsOfOnePe(int id, int peId) {
		...
		return PeListSteady.getMips(HostListSteady.getById(getHostList(), id).getPeList(), peId);
	}
	...
	public int getMips() {
		...
		// Assuming all PEs in all Machine have same rating.
			case DatacenterCharacteristicsSteady.TIME_SHARED:
			case DatacenterCharacteristicsSteady.OTHER_POLICY_SAME_RATING:
				mips = getMipsOfOnePe() * HostListSteady.getNumberOfPes(getHostList());
				break;

			// Assuming all PEs in a given Machine have the same rating.
			// But different machines in a Cluster can have different rating
			case DatacenterCharacteristicsSteady.SPACE_SHARED:
			case DatacenterCharacteristicsSteady.OTHER_POLICY_DIFFERENT_RATING:
	...
	public int getNumberOfPes() {
		return HostListSteady.getNumberOfPes(getHostList());
	}
	...
	public int getNumberOfFreePes() {
		return HostListSteady.getNumberOfFreePes(getHostList());
	}
	...
	public int getNumberOfBusyPes() {
		return HostListSteady.getNumberOfBusyPes(getHostList());
	}
	...
	public boolean setPeStatus(int status, int hostId, int peId) {
		return HostListSteady.setPeStatus(getHostList(), status, hostId, peId);
	}
	 ...
	 */
	protected <T extends HostSteady> void setHostList(List<T> hostList) {
