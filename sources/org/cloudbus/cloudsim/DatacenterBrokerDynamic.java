...
public class DatacenterBrokerDynamic extends SimEntity {
	...
	protected void processCloudletReturn(SimEvent ev) {
		...
		if (getCloudletList().size() == 0 && cloudletsSubmitted == 0) { // all cloudlets executed
			...
			if (getVmList().get(cloudlet.getVmId()).getTotalUtilizationOfCpu(CloudSim.clock()) == 0) {
				//if the cloudlet is the last one of the VM
				//destroy VM
				Log.printLine(CloudSim.clock() + ": " + getName() + ": Destroying VM #" + getVmList().get(cloudlet.getVmId()).getId());
