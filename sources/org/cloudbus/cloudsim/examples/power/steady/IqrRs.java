 ...
 * Inter Quartile Range (IQR) VM allocation policy and Steady Selection (RS) VM
 * selection policy.
 * 
...
public class IqrRs {
	...
	public static void main(String[] args) throws IOException {
		...
		String vmAllocationPolicy = "iqr"; // Inter Quartile Range (IQR) VM
											// allocation policy
		String vmSelectionPolicy = "rs"; // Steady Selection (RS) VM selection
											// policy
