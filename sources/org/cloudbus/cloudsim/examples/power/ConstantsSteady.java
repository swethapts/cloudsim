...
//Max Mips			
//			vmVmSlaCloudletListSteady.add(new VmSlaCloudletListSteady(i,(int) (2256),vmCtSla[i%CLOUDLET_LENGTH_PRIVATE.length][i/CLOUDLET_LENGTH_PRIVATE.length],CLOUDLET_LENGTH_PRIVATE[i%CLOUDLET_LENGTH_PRIVATE.length]*1000)); //E5507, i7
//-otherworkload
