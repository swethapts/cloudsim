 ...
 */
public class VmSchedulerTimeSharedOverSubscriptionSteady extends VmSchedulerTimeSharedSteady {
	 ...
	 */
	public VmSchedulerTimeSharedOverSubscriptionSteady(List<? extends PeSteady> pelist) {
		super(pelist);
	}
	...
	protected void redistributeMipsDueToOverSubscription() {
		...
		double totalAvailableMips = PeListSteady.getTotalMips(getPeList());
