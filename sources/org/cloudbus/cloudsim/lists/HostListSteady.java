...
public class HostListSteady {
	 ...
	 * @post $none
	 */
	public static <T extends HostSteady> T getById(List<T> hostList, int id) {
		for (T host : hostList) {
			if (host.getId() == id) {
				return host;
			}
	 ...
	 * @post $result >= 0
	 */
	public static <T extends HostSteady> int getNumberOfPes(List<T> hostList) {
		int numberOfPes = 0;
		for (T host : hostList) {
	 ...
	 * @post $result >= 0
	 */
	public static <T extends HostSteady> int getNumberOfFreePes(List<T> hostList) {
		int numberOfFreePes = 0;
		for (T host : hostList) {
			numberOfFreePes += PeListSteady.getNumberOfFreePes(host.getPeList());
		}
	 ...
	 * @post $result >= 0
	 */
	public static <T extends HostSteady> int getNumberOfBusyPes(List<T> hostList) {
		int numberOfBusyPes = 0;
		for (T host : hostList) {
			numberOfBusyPes += PeListSteady.getNumberOfBusyPes(host.getPeList());
		}
	 ...
	 * @post $none
	 */
	public static <T extends HostSteady> T getHostWithFreePe(List<T> hostList) {
	 ...
	 * @post $none
	 */
	public static <T extends HostSteady> T getHostWithFreePe(List<T> hostList, int pesNumber) {
		for (T host : hostList) {
			if (PeListSteady.getNumberOfFreePes(host.getPeList()) >= pesNumber) {
				return host;
			}
		}
		return null;
	 ...
	 * @post $none
	 */
	public static <T extends HostSteady> boolean setPeStatus(List<T> hostList, int status, int hostId, int peId) {
