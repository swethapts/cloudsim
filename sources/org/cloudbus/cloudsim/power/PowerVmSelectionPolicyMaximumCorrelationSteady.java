 ...
 */
public class PowerVmSelectionPolicyMaximumCorrelationSteady extends PowerVmSelectionPolicySteady {

	/** The fallback policy. */
	private PowerVmSelectionPolicySteady fallbackPolicy;
	 ...
	 */
	public PowerVmSelectionPolicyMaximumCorrelationSteady(final PowerVmSelectionPolicySteady fallbackPolicy) {
		super();
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.cloudbus.cloudsim.experiments.power.PowerVmSelectionPolicySteady#
	 * getVmsToMigrate(org.cloudbus .cloudsim.power.PowerHostSteady)
	 */
	@Override
	public VmSteady getVmToMigrate(final PowerHostSteady host) {
	 ...
	 */
	protected double[][] getUtilizationMatrix(final List<PowerVmSteady> vmList) {
		int n = vmList.size();
	 ...
	 */
	protected int getMinUtilizationHistorySize(final List<PowerVmSteady> vmList) {
		int minSize = Integer.MAX_VALUE;
		for (PowerVmSteady vm : vmList) {
	 ...
	 */
	public PowerVmSelectionPolicySteady getFallbackPolicy() {
	 ...
	 */
	public void setFallbackPolicy(final PowerVmSelectionPolicySteady fallbackPolicy) {
