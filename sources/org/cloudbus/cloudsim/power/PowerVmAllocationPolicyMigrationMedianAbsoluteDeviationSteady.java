 ...
 */
public class PowerVmAllocationPolicyMigrationMedianAbsoluteDeviationSteady extends
		PowerVmAllocationPolicyMigrationAbstractSteady {

	/** The safety parameter. */
	private double safetyParameter = 0;

	/** The fallback vm allocation policy. */
	private PowerVmAllocationPolicyMigrationAbstractSteady fallbackVmAllocationPolicy;
	 ...
	 */
	public PowerVmAllocationPolicyMigrationMedianAbsoluteDeviationSteady(
			List<? extends HostSteady> hostList,
			PowerVmSelectionPolicySteady vmSelectionPolicy,
			double safetyParameter,
			PowerVmAllocationPolicyMigrationAbstractSteady fallbackVmAllocationPolicy,
	 ...
	 */
	@Override
	protected boolean isHostOverUtilized(PowerHostSteady host) {
		PowerHostUtilizationHistorySteady _host = (PowerHostUtilizationHistorySteady) host;
	 ...
	 */
	protected double getHostUtilizationMad(PowerHostUtilizationHistorySteady host) throws IllegalArgumentException {
	 ...
	 */
	public PowerVmAllocationPolicyMigrationAbstractSteady getFallbackVmAllocationPolicy() {
