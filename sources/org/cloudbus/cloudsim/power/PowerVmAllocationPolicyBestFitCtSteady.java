 ...
 */
public class PowerVmAllocationPolicyBestFitCtSteady extends PowerVmAllocationPolicyAbstractSteady {
	 ...
	 * @param list the list
	 */
	public PowerVmAllocationPolicyBestFitCtSteady(List<? extends HostSteady> list) {
		super(list);
	}
