 ...
 */
public class PowerVmAllocationPolicyWorstCaseSteady extends PowerVmAllocationPolicyAbstractSteady {
	 ...
	 * @param list the list
	 */
	public PowerVmAllocationPolicyWorstCaseSteady(List<? extends HostSteady> list) {
		super(list);
	}
	...
	/*	for (PowerHostSteady host : this.<PowerHostSteady> getHostList()) {
		...
		for (PowerHostSteady host : this.<PowerHostSteady> getHostList()) {
			if (host.isSuitableForVm(vm) && host.getUsed()==false) {
				return host;
			}
		}
		return null;
