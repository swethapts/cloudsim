...
/**
 * Vm represents a VM: it runs inside a HostSteady, sharing hostList with other VMs. It processes
...
public class VmSteady {
	 ...
	 * @param mipsShare array with MIPS share of each PeSteady available to the scheduler
	 ...
	 * 
	 * @param host HostSteady running the VM
	 * @pre host != $null
	 * @post $none
	 */
	public void setHost(HostSteady host) {
		this.host = host;
	}
